...
app.use('/departments', ValidateToken, validateRoles([ROLES.ADMIN, ROLES.CLIENT]), DepartmentRouter);
app.use('/companies', ValidateToken, validateRoles([ROLES.ADMIN, ROLES.CLIENT]), CompanyRouter);
app.use('/avatars', ValidateToken, validateRoles([ROLES.ADMIN, ROLES.CLIENT, ROLES.APPLICANT]), AvatarRouter);
